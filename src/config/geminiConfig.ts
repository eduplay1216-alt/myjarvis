...
// CORREÇÃO: Trocado aspas " por crases ` para suportar múltiplas linhas.
...
// CORREÇÃO: Removido o 'T' que estava sobrando.
    parameters: {
        type: Type.OBJECT,
        properties: {
            tasks_to_delete: {
...
        _t_ startTime: { type: Type.STRING, description: "Data e hora de início no formato ISO 8601 (ex: '2024-08-15T09:00:00Z')." },
