...
        type: Type.OBJECT,
        properties: {
          _ description: { type: Type.STRING, description: 'A descrição da tarefa.' },
...
            _             duration: { type: Type.NUMBER, description: "Duração em minutos. Opcional." }
                    },
                    required: ['description']
                }
            },
