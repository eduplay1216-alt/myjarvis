  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-1 items-center gap-2 sm:gap-3">
      ...
      <button
        ...
        disabled={isDisabled}
        className="bg-gray-700 text-white rounded-full p-3 hover:bg-gray-600 disabled:bg-gray-600 disabled:cursor-not-allowed transition duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-blue-500"
      ...
      <input
        ...
        disabled={isDisabled}
        className="flex-1 min-w-0 bg-gray-800 border-2 border-gray-700 rounded-full py-3 px-4 sm:px-6 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 disabled:opacity-50"
        autoComplete="off"
      />
      <button
        type="submit"
